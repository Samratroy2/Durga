/* =========================================================
   ROY BARI — IDOL MAKERS ADMIN
   Firestore collection: idolMakers
...
const FIELDS = [
...

    {
        ...
        type: "text",
        required: false,
        placeholder: "Current Idol Maker"
    },
...
/*
 * Original record data while editing.
 *
 * Used to determine which fields changed.
 */
...
async function saveRecord(
    ...
    try {
        ...
        if (
            ...
            /*
             * Find changed fields BEFORE updating.
             */
        ...
        /* =================================================
           ...
           ================================================= */
            ...
            await createActivityLog({
                ...
                details:
                    `Idol maker created with ID ${created.id}.`
...
async function createActivityLog({
    ...
    try {
        ...
        /*
         * The idol maker operation has already
         * succeeded, so activity failure should
         * not make the main operation appear failed.
         */
